...
import edos.distribution.mirror.StoreStructureDocument;
...
/**
 * This example shows how to store a document 
 * from the file system to the XML database.
 * 
 * @author marc
 *
 */
public class StoreStructureDocument {
	private static Logger logger = Logger.getLogger(StoreStructureDocument.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			struct = new TreeMirrorStructure(fin);
			...
			logger.fatal("Unable to store " + struct.getFilename());
		}
